...
public class DAOPokemonJPATest {
    ...
    public static void initTestFixture() throws Exception {
        ...
        java.sql.Connection connection=((EntityManagerImpl) (entityManager.getDelegate())).getServerSession().getAccessor().getConnection();
    ...
    public void testUpdate() throws Exception {
        ...
        assertThat(pikachu.ge()).isGreaterThan(0);
        pikachu.setAttack(-1);
        dao.update(pikachu);
